...
\name{Anil Kumar Reddy}{Konda}
% \position{Software Architect{\enskip\cdotp\enskip}Security Expert}
% \address{YOUR ADDRESS}

\mobile{+1 (737) 420 9761}
\email{kondaanil76@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com} 
\github{github.com/anil7620}
\linkedin{linkedin.com/in/anil7620}
% \gitlab{gitlab-id}
...
\input{cv/certificates} % this will be certifications
\input{cv/achievements.tex}
% \input{cv/badges.tex}
\input{cv/responsibilities}
